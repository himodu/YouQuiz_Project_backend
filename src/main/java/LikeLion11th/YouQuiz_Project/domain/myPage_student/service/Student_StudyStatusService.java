package LikeLion11th.YouQuiz_Project.domain.myPage_student.service;

import LikeLion11th.YouQuiz_Project.domain.myPage_student.repository.QuizRepository;
...
public class Student_StudyStatusService {
    ...
    public JSONObject findStudyStatus(Long studentId, Long chapId) { // Find Learning Status of Each Chapter
          ...
          Optional<AnswerEntity> answerEntity = answerRepository.findByChapterEntityAndStudentEntity(chapId, studentId);
